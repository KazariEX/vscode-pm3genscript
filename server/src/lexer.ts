...
export const is: {
    ...
    byte: (str) => is.literal(str) && Number(str) <= 0xFF,
    word: (str) => is.literal(str) && Number(str) <= 0xFFFF,
    dword: (str) => is.literal(str) && Number(str) <= 0xFFFFFFFF,
    ...
    literal: (str) => (literal.PATTERN as RegExp).test(str),
